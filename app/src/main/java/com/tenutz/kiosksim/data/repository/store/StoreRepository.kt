package com.tenutz.kiosksim.data.repository.store

import com.tenutz.kiosksim.data.datasource.api.dto.common.CommonCondition
import com.tenutz.kiosksim.data.datasource.api.dto.store.ReviewReplyCreateRequest
import com.tenutz.kiosksim.data.datasource.api.dto.store.ReviewReplyUpdateRequest
import com.tenutz.kiosksim.data.datasource.api.dto.store.SalesRequest
import com.tenutz.kiosksim.data.datasource.api.dto.store.SalesTotalResponse
import com.tenutz.kiosksim.data.datasource.api.dto.store.StatisticsSaleByMenusRequest
import com.tenutz.kiosksim.data.datasource.api.dto.store.StatisticsSalesByCreditCardResponse
import com.tenutz.kiosksim.data.datasource.api.dto.store.StatisticsSalesByMenusTodayResponse
import com.tenutz.kiosksim.data.datasource.api.dto.store.StatisticsSalesByTimeResponse
import com.tenutz.kiosksim.data.datasource.api.dto.store.StatisticsSalesTotalByCreditCardResponse
import com.tenutz.kiosksim.data.datasource.api.dto.store.StatisticsSalesTotalByMenusResponse
import com.tenutz.kiosksim.data.datasource.api.dto.store.StatisticsSalesTotalByTimeResponse
import com.tenutz.kiosksim.data.datasource.api.dto.store.StoreMainResponse
